...
void PrestadorBuscar::onPushButtonSeleccionar_clicked(){
...
void PrestadorBuscar::on_pushButtonImprimir_clicked()
{
    PrintPrestadorBusqueda *p = new PrintPrestadorBusqueda();
    p->close();
}
